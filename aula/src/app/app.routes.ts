...
import { loginGuard } from './auth/login.guard'; //Guard que garante que apenas usuários autenticados consigam acessar

export const routes: Routes = [
  {path: "", redirectTo: "login", pathMatch: 'full'},
  {path: "login", component: LoginComponent},

  {path: "admin", component: PrincipalComponent, canActivate: [loginGuard], children: [ //canActive protege a rota, permitindo o acesso apenas a usuários autenticados. //children para permitir rotas aninhadas.
